...
$(window).scroll(function() {
    ...
    if(y_scroll_pos > scroll_pos_test) {
        ...
        $("#counter-rails").counter("start");
        $("#counter-go").counter("start");
...
$(document).ready(function(){ $("#counter-rails").counter({
  autoStart: false,           // true/false, default: true
  duration: 2000,             // milliseconds, default: 1500
  countFrom: 0,
...
$(document).ready(function(){ $("#counter-go").counter({
  autoStart: false,           // true/false, default: true
  duration: 2000,             // milliseconds, default: 1500
  countFrom: 0,
 ...
 $(document).ready(function(){ $("#counter-angular").counter({
  ...
  duration: 2000,             // milliseconds, default: 1500
  countFrom: 0,
  countTo: 65 ,                // count to this number, default: 0
  runOnce: true,              // only run the counter once, default: false
  placeholder: 0 +"%",           // replace the number with this before counting,
                              // most useful with autoStart: false. default: undefined
  easing: "easeOutCubic",     // see http://gsgd.co.uk/sandbox/jquery/easing
 ...
 $(document).ready(function(){ $("#counter-react").counter({
  autoStart: false,           // true/false, default: true
  duration: 2000,             // milliseconds, default: 1500
  countFrom: 0,
...
console.log(top);
    ...
    if (top > 1400 && top < 3500) { $("#javascript").animate({width:"80%"}, 2000);
    } else {
        $("#javascript").stop(true).animate({width:"0"}, '2000');
    }
    if (top > 1400 && top < 3750) {$("#rails").animate({width:"75%"}, 2000);
    }
    else {
        $("#rails").stop(true).animate({width:"0"}, '2000');
    }
    if (top > 1400 && top < 3500) { $("#go").animate({width:"60%"}, 2000);
    } else {
        $("#go").stop(true).animate({width:"0"}, '2000');
    }

     if (top > 1400 && top < 3850) { $("#python").animate({width:"60%"}, 2000); }
    else {
        $("#python").stop(true).animate({width:"0"}, '2000');
    }

     if (top > 1400 && top < 3500) { $("#bootstrap").animate({width:"90%"}, 2000); }
    else {
        $("#bootstrap").stop(true).animate({width:"0"}, '2000');
    }

     if (top > 1400 && top < 3500) { $("#jquery").animate({width:"85%"}, 2000); }
    else {
        $("#jquery").stop(true).animate({width:"0"}, '2000');
    }

     if (top > 1400 && top < 3500) { $("#angular").animate({width:"65%"}, 2000); }
    else {
        $("#angular").stop(true).animate({width:"0"}, '2000');
    }

     if (top > 1400 && top < 3500) { $("#nodejs").animate({width:"90%"}, 2000); }
    else {
     ...
     if (top > 1400 && top < 3750) { $("#git").animate({width:"90%"}, 2000); }
    else {
        $("#git").stop(true).animate({width:"0"}, '2000');
    }

     if (top > 1400 && top < 3850) { $("#react").animate({width:"50%"}, 2000); }
    else {
        $("#react").stop(true).animate({width:"0"}, '2000');
    }

     if (top > 3000 && top < 4800) { $("#windows").animate({width:"85%"}, 2000); }
    else {
        $("#windows").stop(true).animate({width:"0"}, '2000');
    }
    if (top > 3200 && top < 4800) { $("#android").animate({width:"70%"}, 2000); }
    else {
        $("#android").stop(true).animate({width:"0"}, '2000');
    }
    if (top > 3400 && top < 4800) { $("#linux").animate({width:"90%"}, 2000); }
    else {
        $("#linux").stop(true).animate({width:"0"}, '2000');
    }
    if (top > 3600 && top < 4800 ) { $("#osx").animate({width:"80%"}, 2000); }
    else {
